...
[CustomPropertyDrawer(typeof(Enum4ButtonsAttribute))]
public class Enum4ButtonsAttributeDrawer : PropertyDrawer {
...
//        var parentType = property.serializedObject.targetObject.GetType();
        ...
        //_columnCount = Mathf.Min(_entries.Count, Mathf.CeilToInt(_entries.Count / 3f) == _rowCount ? 3 : ByThree ? 3 : 4);
        _columnCount = Mathf.Min(_entries.Count, Mathf.CeilToInt(_entries.Count / 3f) == _rowCount ? 4 : 5);
    }
